// Comunas por región (puedes agregar más comunas según necesidad)
const comunasPorRegion = {
    ...
    "Valparaíso": ["Valparaíso", "Quilpué","Casablanca", "Concón", "Juan Fernández", "Puchuncaví", "Quintero", "Viña del Mar", "Isla de Pascua", "Los Andes", "Calle Larga", "Rinconada", "San Esteban", "La Ligua", "Cabildo", "Papudo", "Petorca", "Zapallar", "Quillota", "Calera", "Hijuelas", "La Cruz", "Nogales", "San Antonio", "Algarrobo", "Cartagena", "El Quisco", "El Tabo", "San Antonio", "Santo Domingo", "San Felipe", "Catemu", "Llaillay", "Panquehue", "Putaendo", "Santa María"],
...
document.addEventListener('DOMContentLoaded', function () {
    // Script que solo permite escribir la K y números, y no permite que el primer carácter sea 0
    ...
    // Inicializa selects de Materialize
    ...
    if (regionSelect && comunaSelect) {
        regionSelect.addEventListener('change', function () {
            ...
            // Vuelve a inicializar el select de Materialize
            M.FormSelect.init(comunaSelect);
        });
    }
});